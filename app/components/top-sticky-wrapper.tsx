    ...
    <div className="h-screen relative">
      <div className="px-12 grid grid-cols-3 gap-20 pt-48">
        <div className="col-span-2">
          ...
          <p className="text-4xl font-normal mt-24">
          ...
          <div className="mt-8 text-xl">
            {projects.map((project, index) => (
              <div key={index} className="group">
                <div className="border-b-3  font-light border-b-2 py-5 group-hover:border-black duration-500 flex justify-between items-center">
                  {project.title}
